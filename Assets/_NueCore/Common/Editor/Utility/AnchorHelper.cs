...
namespace _NueCore.Common.Editor.Utility
{
    public static class AnchorHelper
    {
        ...
        // Hotkey: Alt+A
        [MenuItem("NueCore/Utility/UI/Anchor To Rect &a")]
        ...
        [MenuItem("NueCore/Utility/UI/Anchor To Rect Width")]
        ...
        [MenuItem("NueCore/Utility/UI/Anchor To Rect Height")]
    ...
    public static class MoveAnchorsToCornersExtentions
    {
#if UNITY_EDITOR
